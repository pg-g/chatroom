...
app.controller('mainCtrl', function($scope, parseService){
  ...
  //The getParseData function will call the getData method on the parseService object. You'll then save the result of that request to your controller's $scope as messages ($scope.messages)
  $scope.getParseData = function() {
    parseService.getData().then(function(words) {
      $scope.messages = words.data.results;
  ...
  //This goes and gets new data every second, mimicking a chat room experience.
